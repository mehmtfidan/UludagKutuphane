    ...
    public partial class kitaguncelle : Form
    {
        ...
        private void KitapGFiltre_txt_TextChanged(object sender, EventArgs e)
        {
            if (comboBox1.SelectedIndex== 1)
            {
                ...
                MySqlDataAdapter ara = new MySqlDataAdapter("select * from Kitap where Ki_Adi like '%" + KitapGFiltre_txt.Text + "%' ", con);
                ara.Fill(tbl);
                con.Close();
            ...
            else if (comboBox1.SelectedIndex == 2)
            {
                ...
                MySqlDataAdapter ara = new MySqlDataAdapter("select * from Kitap where Y_Adi like '%" + KitapGFiltre_txt.Text + "%' ", con);
                ara.Fill(tbl);
                con.Close();
                KitapGuncelle_dgv.DataSource = tbl;
            ...
            else if (comboBox1.SelectedIndex == 3)
            {
                ...
                MySqlDataAdapter ara = new MySqlDataAdapter("select * from Kitap where Demirbas_No like '%" + KitapGFiltre_txt.Text + "%' ", con);
                ara.Fill(tbl);
                con.Close();
                KitapGuncelle_dgv.DataSource = tbl;
            }
