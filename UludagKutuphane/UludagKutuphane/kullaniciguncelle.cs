...
namespace UludagKutuphane
{
    public partial class kullaniciguncelle : Form
    {
        ...
        private void KullaniciGuncelle_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Bolum_cmb.Text = KullaniciGuncelle_dgv.CurrentRow.Cells[7].Value.ToString();
            KullaniciCeza_txt.Text = KullaniciGuncelle_dgv.CurrentRow.Cells[6].Value.ToString();
